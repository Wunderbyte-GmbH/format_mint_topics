 ...
 */
class format_mint_topics_test extends \advanced_testcase {

    /**
     * Tests for format_mint_topics::get_section_name method with default section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_mint_topics::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_mint_topics::get_default_section_name.
     *
     * @return void
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_mint_topics');
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            } else {
                $sectionname = get_string('sectionname', 'format_mint_topics') . ' ' . $section->section;
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            }
        }
    }
    ...
    public function test_update_inplace_editable() {
        ...
        try {
            \core_external::update_inplace_editable('format_mint_topics', 'sectionname', $section->id, 'New section name');
        ...
        $res = \core_external::update_inplace_editable('format_mint_topics', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        // Call callback format_mint_topics_inplace_editable() directly.
        $tmpl = component_callback('format_mint_topics', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
